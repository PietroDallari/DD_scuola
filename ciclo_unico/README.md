# ciclo_unico — lavoro ORA sul ciclo unico scolastico

Spazio di lavoro del filone **ciclo unico**. Qui vanno **solo** le nostre cose;
il codice di Nazareno Lecis resta nel clone nidificato `../Ciclo_unico_scolastico/`
(gitignorato, sola lettura), usato solo tramite driver esterni.

## Struttura
- `note/` — orientamento, divisione dei compiti, pin upstream (`pin_upstream.md`).
