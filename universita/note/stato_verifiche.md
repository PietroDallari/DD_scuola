...
| B3 | FIS budget/schema + esiti | **[V]** | Starting 40/48,5/50% (critica "anti-giovani" FALSA); successo **2,46% → 4,63% → 6,52%** (FIS3 326/>5.000) vs ERC 14,2%; FIS2=338M. Revoche 2026 a parte | `.../b3_fis_esiti_nota.md` |
...
| B11 | Contribuzione + scenari gratuità | **[V]** | esonerati **38,0%**; gettito statali **1,49 mld** (914€ × 1.632.163 statali); gratuità flat 200€ = **~1,24 mld** (range 0,86-1,49); tetto 20% FFO (DPR 306/97) | USTAT Focus 2022/23 + ANS → `.../b11_contribuzione_nota.md` |
...
| F3,F5,F6 | Figure premiale / successo FIS / precariato | **[V]** | F3 scatter premiale/FFO; F5 FIS 2,46/4,63/**6,52%** vs ERC 14,2% (3 barre FIS + ERC); F6 RTD 4,1%→11,2% | `figures/f3_*,f5_*,f6_*.png` |
...
## Stato finale (2026-07-18)
Tutte le verifiche **[V]** (con 2 contraddizioni risolte via 3 stress test: B5 Gini, §2.1 Sud). Recepite in v2/v2.1 (changelog). **Unico aperto: B1** (legge Bernini) — attesa pubblicazione in GU: alla pubblicazione, mappa modifiche L.240/2010 + 3 domande (platea sorteggio / profilatura bandi / transitorio) per §1.3-§4.1-§9. Additivo di report (penna a Claude-chat): inserire FIS3 6,52% al §1.2.
